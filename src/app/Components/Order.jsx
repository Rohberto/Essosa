  ...
  return (
    <div className='order_container' data-scroll-section>
        ...
        <div className="order_cards">
            <div className="card_group"> <div className="card_img_container"><img src="/card1.png" alt="card 1" /></div>
            <div className="card_img_container"><img src="/card2.png" alt="card 1" /></div></div>
